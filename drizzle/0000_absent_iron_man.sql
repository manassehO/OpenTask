...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "opentask_task" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"title" varchar(255),
	"description" text,
	"status" varchar(50),
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "opentask_task" ADD CONSTRAINT "opentask_task_creator_id_opentask_user_id_fk" FOREIGN KEY ("creator_id") REFERENCES "public"."opentask_user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
